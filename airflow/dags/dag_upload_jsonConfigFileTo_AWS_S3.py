...
#         logging.info(
#             "Start to upload files to aws s3: job flow and spark spark step files")

#         # Upload Job flow file from local to aws s3
#         upload_job_flow_file_from_local_to_s3 = UploadFilesFromLocalToS3(
...
#         upload_spark_step_file_from_local_to_s3 = UploadFilesFromLocalToS3(
...
#         logging.info(
#             "Completely to upload files to aws s3: job flow and spark spark step files")

#     end = DummyOperator(
#         task_id='Completed_upload_job_and_spark_step_files_from_local_to_aws_s3')
